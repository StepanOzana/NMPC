function [p,jh,l,h,ic,OK]=solnp(pb,ib,op,l,h)
%
if exist('pb')<=0.5,
  disp('Syntax error')
  return
...
%
%  opd=[1 10 100 1.0e-5 1.0e-4];  % funkcni
 opd=[1 10 100 1.0e-5 1.0e-4];  % pokusne
...
%   p(nic+1:nic+np),
  ob=costF(p(nic+1:nic+np),iteration);
